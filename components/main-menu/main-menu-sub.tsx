...
export default function MainMenuSub({ options }: Props) {
  return (
    <ul className="absolute opacity-0 invisible -left-6 -right-6 border bg-background border-stone-500 py-2 px-4 group-hover:opacity-100 group-hover:visible transition-all duration-200">
      {options.map((link) => (
